...
export function Editor({newNode, onEvent}) {
    ...
    useEffect(() => {
        ...
        nui.svg.addEventListener('selected', (e: CustomEvent) => {
            arrSelect = e.detail;
            eventEmit({name: 'selected', arrSelect})
        })
        nui.svg.addEventListener('dragged', (e: CustomEvent) => {
            eventEmit({name: 'dragged'})
        })
        nui.svg.addEventListener('link-create', (e: CustomEvent) => {
            eventEmit({name: 'link-create'})
        })
        nui.svg.addEventListener('link-remove', (e: CustomEvent) => {
            eventEmit({name: 'link-remove'})
        })
        nui.svg.addEventListener('node-remove', (e: CustomEvent) => {
            eventEmit({name: 'node-remove'})
        })
